...
const Home = ({ musics }: InferGetStaticPropsType<typeof getStaticProps>) => {
  return (
    <div className="min-h-screen flex flex-col bg-gray-200 pb-12">
      <header className="bg-white pt-12 pb-20 px-6 sm:px-6 lg:px-8 rounded-b-lg shadow-sm">
        <FaBible className="mx-auto text-6xl text-sky-600" />
        <h1 className="text-3xl mt-6 text-center font-extrabold text-gray-900">
          Betel Músicas
        </h1>
